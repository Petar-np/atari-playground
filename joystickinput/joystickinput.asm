...
Reset:
    CLEAN_START                 ; macro to clean memory an TIA
...
DivideLoop:
    ...
    sta WSYNC                   ; wait for next scanline
    sta HMOVE                   ; apply the fine postion offset
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    ldy 17                      ; counter to draw 17 rows of bitmap
DrawBitmap:
    ...
    sta WSYNC                   ; wait for next scaline
...
Overscan:
    lda #2
    sta VBLANK                  ; turn VBLANK on again overscan
    REPEAT 30
        sta WSYNC
    REPEND

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Joystick input test fro P0 up/down/left/right
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
CheckP0Up:
    lda #%00010000
    bit SWCHA
